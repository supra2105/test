  ...
  $(document).ready(function () {
    ...
    if ($(".fullpage-default").length) {
      var myFullpage = new fullpage(".fullpage-default", {
        ...
        anchors: ["top", "about", "skills", "work", "contact"],
        menu: "#nav",
        lazyLoad: true,
        navigation: true,
        ...
        onLeave: function (origin, destination, direction) {
          if (destination.index === 0) {
            $("#scrollDown").removeClass("scrollHide");
            $("#scrollDown").addClass("scrollShow");
          } else {
            $("#scrollDown").removeClass("scrollShow");
            $("#scrollDown").addClass("scrollHide");
          }
        },
      });
    }
    $(document)
      .on("click", ".navbar-toggle", function () {
        ...
        $(".dark-bg, .bg-none").toggleClass("dark-bg bg-none");
